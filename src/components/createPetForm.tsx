...
export default function CreatePet() {
  ...
  return (
    <div className='my-4 pb-4 border-b w-8/12 mx-auto'>
      <h2 className='text-2xl font-medium text-center m-2'>Add Pets Details</h2>
      <form className='flex items-center justify-between flex-col sm:flex-col lg:flex-row' onSubmit={onSubmit}>
        <input
          type='text'
          className='bg-white-100 lg:w-[30%] w-full mb-4 lg:mb-0 rounded-md border-blue-500'
        ...
        <button
          ...
          onClick={onSubmit}
          disabled={isLoading}
          className='bg-blue-400 w-full max-w-sm lg:max-w-fit disabled:bg-green-400 disabled:cursor-progress disabled:shadow-none text-white uppercase font-semibold px-8 py-2 rounded-md hover:shadow-md transition-all duration-200'>
          {isLoading ? (
